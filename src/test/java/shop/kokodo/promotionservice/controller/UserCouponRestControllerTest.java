                ...
                .andDo(
                        document("user-coupon-rest-controller/find-user-notUsed-rateCoupon-by-productId",
                                ...
                                responseFields(
                                        ...
                                        fieldWithPath("result.data[].arRateCoupon").type(JsonFieldType.OBJECT).description("비율 할인쿠폰 마지막 수정 날짜").optional(),
                ...
                .andDo(
                        document("user-coupon-rest-controller/rateCoupon-list",
                                ...
                                responseFields(
                                        ...
                                        fieldWithPath("result.data.*[].arRateCoupon").type(JsonFieldType.OBJECT).description("비율 할인 쿠폰 생성 날짜").optional(),
