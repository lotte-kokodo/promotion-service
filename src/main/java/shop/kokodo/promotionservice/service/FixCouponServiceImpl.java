...
public class FixCouponServiceImpl implements FixCouponService{
    ...
    private FixCoupon convertToFixCoupon(FixCouponDto fixCouponDto,long productId){
        return FixCoupon.builder()
                ...
                .startDate(LocalDateTime.parse(fixCouponDto.getStartDate(), DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")))
                .endDate(LocalDateTime.parse(fixCouponDto.getStartDate(), DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")))
                .productId(productId)
